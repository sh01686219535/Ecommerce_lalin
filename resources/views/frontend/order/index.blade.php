            ...
            <div class="row">
                ...
                <div class="col-sm-5 cus-order-2">
                    <div class="checkout-shipping">
                        <form action="{{ route('user.order', $products->id) }}" method="POST" data-parsley-validate
                            novalidate>
                            @csrf
                            <div class="card">
                                ...
                                <table class="cart_table table table-bordered table-striped text-center mb-0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            @if ($products->discount_price)
                                                <td><span id="net_total">{{ $products->discount_price }}</span></td>
                                            @else
                                        ...
                                        <tr>
                                            ...
                                            @if ($products->discount_price)
                                                <td><span id="grand_total">{{ $products->discount_price }}</span></td>
                                            @else
